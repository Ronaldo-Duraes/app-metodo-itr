        ...
        <div className="relative">
          ...
          >
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[8px] font-black text-orange-500 uppercase tracking-widest leading-none mt-1 opacity-80">
                  {profile?.role === 'admin' ? 'Administrador' : profile?.role === 'aluno' ? 'Aluno ITR' : (profile?.role === 'usuario' || user) ? 'Usuário' : 'Convidado'}
              </p>
            </div>
            
            <div className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-white/10 overflow-hidden bg-zinc-900 flex items-center justify-center group-hover:border-orange-500/50 transition-colors">
              {isVisitor ? (
                ...
                >
                  ...
                  {user ? (
                    ...
                    <button 
                      ...
                      className="w-full flex items-center gap-3 p-4 min-h-[44px] bg-orange-500/5 text-orange-500 border border-orange-500/10 hover:bg-orange-500 hover:text-black transition-all text-[10px] font-black uppercase tracking-widest text-left mt-2 group"
                    >
