...
const MODULES = [
  ...
  { id: 5, title: 'Módulo 5: Maestria Final e Certificação', description: 'A consolidação do espanhol em nível recorde.', lessons: 6, status: 'locked' },
];
        ...
        <header className="mb-6 md:mb-16">
          ...
          >
            ...
            <h1 className="text-xl md:text-4xl lg:text-6xl font-black tracking-tighter uppercase leading-[0.9]">
              ...
              <span className="text-orange-500">Seu Arsenal de Conhecimento</span>
            </h1>
          </motion.div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-10">
          ...
          <div className="lg:col-span-8 space-y-3 md:space-y-8">
            ...
            >
              ...
              <div className="absolute inset-0 bg-orange-500/5 opacity-0 group-hover:opacity-100 transition-opacity z-10" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
                <motion.div 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-orange-500 flex items-center justify-center shadow-[0_0_50px_rgba(16,185,129,0.4)] group-hover:bg-orange-400 transition-colors"
                >
              ...
              <div className="absolute bottom-0 left-0 w-full p-3 md:p-8 z-20 flex justify-between items-end">
                <div>
                  ...
                  <div className="flex items-center gap-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                    ...
                    <span>Aula 01</span>
                    <span>•</span>
                    <span className="text-orange-500">Concluído</span>
                  </div>
                </div>
            ...
            <div className="p-4 md:p-10 border border-white/5 bg-white/[0.02] backdrop-blur-xl">
               <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-center justify-between">
                 <div className="max-w-xl">
                   <h4 className="text-xl font-black uppercase tracking-tight mb-4 flex items-center gap-3 text-orange-500">
                     <ShieldCheck size={20} />
                 ...
                 <button 
                   onClick={handleRedirect}
                   className="flex-shrink-0 w-full md:w-auto px-8 md:px-10 py-4 md:py-5 bg-white text-black font-black text-xs tracking-[0.2em] uppercase hover:bg-orange-500 transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)] flex items-center justify-center gap-4 group min-h-[48px]"
                 >
                   Assistir no Cakto
                ...
                <motion.div 
                  ...
                  className={`p-3 md:p-6 border transition-all cursor-pointer relative group min-h-[48px] ${
                    mod.status === 'locked' 
                      ...
                      : mod.status === 'current'
                      ? 'border-orange-500/50 bg-orange-500/5 shadow-[0_0_30px_rgba(16,185,129,0.05)]'
                      : 'border-white/10 bg-white/[0.02] hover:border-white/30'
                  }`}
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <span className={`text-[10px] font-black uppercase tracking-widest mb-1 block ${mod.status === 'current' ? 'text-orange-500' : 'text-slate-600'}`}>
                        {mod.lessons} Aulas
                      </span>
                      <h4 className="text-sm font-black uppercase tracking-tight mb-2 group-hover:text-orange-500 transition-colors">
                        {mod.title}
                      </h4>
